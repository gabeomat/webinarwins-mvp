...
export default function Button({ 
  ...
  const baseStyles = 'font-bold border-brutal border-brutal-black uppercase transition-all duration-100 active:translate-x-1 active:translate-y-1 active:shadow-none disabled:opacity-50 disabled:cursor-not-allowed disabled:active:translate-x-0 disabled:active:translate-y-0';
